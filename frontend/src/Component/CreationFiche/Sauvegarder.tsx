...
function Sauvegarder({ redirection, setSaveName }: any) {
    ...
    return (
        <div>
            <input className="input_sauvegarder_ficheBox" type="text" placeholder="Nom de la fiche" 
                value={nomFiche}
                onChange={handleInputChange}
            />
            <button className="boutton_sauvegarder_ficheBox" onClick={sauvegarde}>Sauvegarder</button>
        </div>
    );
};
